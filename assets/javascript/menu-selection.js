//default load info
window.onload = set_default;

//has the page loaded once before
var loaded = false;
...
//default icon (for when page is first loaded)
function set_default(){
	var home = document.getElementById('home-icon');
	add_active(home);
}

//get current active div
function get_activeID(){

	var active;

	//home icon active
	if(document.getElementById('home-icon').classList.contains("active"))
	{
		active = 'home-icon';
	}
	elseif(document.getElementById('my-story').classList.contains("active"))
	{
		active = 'my-story';
	}
	elseif(document.getElementById('soundcloud').classList.contains("active"))
	{
		active = 'soundcloud';	
	}
	elseif(document.getElementById('store').classList.contains("active"))
	{
		active = 'store';
	}
